...
if (isset($_GET['delete_id'])) {
    ...
    $delete_msg = $objectCrudAdmin->delete_data($delete_id);
}
    ...
    <table class="table table-responsive">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-success" href="edit.php?id=<?php echo $student['id']; ?>">Edit</a>
                    <a class="btn btn-warning" href="index.php?delete_id=<?php echo $student['id']; ?>" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a>
                </td>
            </tr>
            <?php } ?>
        </tbody>
